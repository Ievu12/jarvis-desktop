"""Vienkartinis Gmail OAuth prijungimo scenarijus.
...
print("=== Gmail OAuth prijungimas (READ-only) ===\n")
...
state = "jarvis-gmail-setup"  # vienkartinei rankinei sesijai pakanka fiksuotos reikšmės
...
print("\nDabar galite patikrinti: jarvis integrations  (turėtų rodyti 'gmail: configured.')")
